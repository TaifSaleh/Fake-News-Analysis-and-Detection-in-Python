...
# Representation - Loading and Preprocessing the Datasets
print("---------Representation----------")
print("\n")
fakeNews = pd.read_csv('Fake.csv')
realNews = pd.read_csv('True.csv')

#create two bar plots to represent the data in the datasets
...
# Add a label column to indicate real news with 1 or fake news with 0
fakeNews['isReal'] = 0
realNews['isReal'] = 1

# Concatenate the datasets to a Dataframe
...
# Evaluation - Training and Evaluating the Models
print("\n")
print("---------Evalation----------")
print("Training and Evaluating the Models:")
print("\n")

# Train the TfidfVectorizer on the training set and 
